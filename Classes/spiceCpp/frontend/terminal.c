...
#include <stdarg.h>
//#include "outToCpp.h"
extern void outToCppClass(char* str);
...
static int noprint, nopause;


/* Start output... */

int out_isReturnLine = FALSE;
...
out_init(void)
{
    ...
    out_isReturnLine = noprint = nopause = FALSE;
