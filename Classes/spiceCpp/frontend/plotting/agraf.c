...
void
ft_agraf(double *xlims, double *ylims, struct dvec *xscale, struct plot *plot, struct dvec *vecs, double xdel, double ydel, int xlog, int ylog, int nointerp)
{
    int height;
    //bool nobreakp, novalue;
    int nobreakp, novalue;
    int maxx, maxy, omaxy;  /* The size of the plotting area. */
    //bool /* xlogscale = FALSE, */ ylogscale = FALSE;
    int /* xlogscale = FALSE, */ ylogscale = FALSE;
