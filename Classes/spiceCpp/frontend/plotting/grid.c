...
//static void drawlingrid(GRAPH *graph, char *units, int spacing, int nsp, double dst, double lmt,double hmt, bool onedec, int mult, double mag, int digits, Axis axis);
static void drawlingrid(GRAPH *graph, char *units, int spacing, int nsp, double dst, double lmt,double hmt, int onedec, int mult, double mag, int digits, Axis axis);
...
void
drawlingrid(GRAPH *graph, char *units, int spacing, int nsp, double dst, double lmt, double hmt, int onedec, int mult, double mag, int digits, Axis axis)
{
    int i, j;
    double m, step;
