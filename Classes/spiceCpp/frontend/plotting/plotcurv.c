...
//static void plotinterval(struct dvec *v, double lo, double hi, register double *coeffs,int degree, bool rotated);
static void plotinterval(struct dvec *v, double lo, double hi, register double *coeffs,int degree, int rotated);
...
void
ft_graf(struct dvec *v, struct dvec *xs, int nostart)
{
...
static void
plotinterval(struct dvec *v, double lo, double hi, register double *coeffs, int degree, int rotated)
{
