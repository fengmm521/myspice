...
static void gr_start_internal(struct dvec *dv, int copyvec);
static int iplot(struct plot *pl, int id);
//static void set(struct plot *plot, struct dbcomm *db, bool unset, short mode);
static void set(struct plot *plot, struct dbcomm *db, int unset, short mode);
...
static void
gr_start_internal(struct dvec *dv, int copyvec)
{
...
static void
set(struct plot *plot, struct dbcomm *db, int unset, short mode)
{
    struct dvec *v;
    struct dbcomm *dc;
