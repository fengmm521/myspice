...
int cp_nocc;               /* Don't do command completion. */
...
static wordlist *cctowl(struct ccom *cc, int sib);
//static struct ccom *clookup(register char *word, struct ccom **dd, bool pref,int create);
static struct ccom *clookup(register char *word, struct ccom **dd, int pref,int create);
...
void
cp_ccom(wordlist *wlist, char *buf, int esc)
{
    struct ccom *cc;
...
static struct ccom *
clookup(register char *word, struct ccom **dd, int pref, int create)
{
