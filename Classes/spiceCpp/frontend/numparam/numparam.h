...
int defsubckt(dico_t *, char *s, int w, char categ);
...
//int nupa_substitute(dico_t *, char *s, char *r, bool err);
int nupa_substitute(dico_t *, char *s, char *r, int err);
int nupa_assignment(dico_t *, char *s, char mode);
//int nupa_subcktcall(dico_t *, char *s, char *x, bool err);
int nupa_subcktcall(dico_t *, char *s, char *x, int err);
