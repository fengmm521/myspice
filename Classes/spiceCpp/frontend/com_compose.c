...
//    bool sdgiven = FALSE;
    int startgiven = FALSE, stopgiven = FALSE, stepgiven = FALSE;
    int lingiven = FALSE;
    int loggiven = FALSE, decgiven = FALSE, gaussgiven = FALSE;
    int randmgiven = FALSE;
    int spangiven = FALSE;
    int centergiven = FALSE;
    int meangiven = FALSE;
    int poolgiven = FALSE;
    int sdgiven = FALSE;
