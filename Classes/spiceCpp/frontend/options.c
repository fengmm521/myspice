...
int ft_acctprint = FALSE, ft_noacctprint = FALSE, ft_listprint = FALSE;
int ft_nodesprint = FALSE, ft_optsprint = FALSE, ft_noinitprint = FALSE;
int ft_ngdebug = FALSE, ft_stricterror = FALSE;
...
int
cp_usrset(struct variable *var, int isset)
{
    void *vv;
    struct variable *tv;
    int iv;
